...
export default function HomePage() {
  ...
  return (
    <main className="flex min-h-screen flex-col items-center bg-gradient-to-b overflow-clip from-blue-950 to-violet-950 text-white relative dark">
      ...
      <div className="absolute w-full h-1/3 bg-gradient-to-b from-slate-950 to-transparent">
      </div>
      <div className="fixed top-0 right-0 p-6">
        <a href="https://github.com/riolly/ssd-wad-calendar" target="_blank">
          <GithubIcon size={48} className="text-black rounded-full bg-gray-200 p-1.5" />
        </a>
      </div>


      <div className="container flex flex-col items-center py-12 ">
        <h1 className="-mt-2 mb-6 text-5xl font-semibold z-10">
